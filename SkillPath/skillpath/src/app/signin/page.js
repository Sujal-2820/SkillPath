    ...
    <div className="min-h-screen bg-white flex flex-col md:flex-row relative">
      ...
      <div className="hidden md:flex md:w-1/2 bg-gray-50 justify-center items-center p-12">
        <div className="max-w-md">
          <h2 className="text-3xl font-bold mb-6">Welcome Back to SkillPath</h2>
          <p className="text-xl text-gray-600">
            Continue your learning journey and unlock new skills with our structured learning paths.
          </p>
        </div>
      </div>
